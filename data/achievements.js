...
const ACHIEVEMENTS = [
  ...
  // ── Rareté ────────────────────────────────────────────────────────────────
  { id:"rarity_first_epic",    cat:"Rareté", icon:"🟣", name:"Première Épique",         desc:"Diagnostiquer une voiture Épique",                                      cond:s=>(s.totalEpicSeen??0)>=1,                                                      reward:{rep:50,    money:5000,     talent:0} },
  { id:"rarity_epic_10",       cat:"Rareté", icon:"🟣", name:"Chasseur d'Épiques",       desc:"Avoir vu 10 voitures Épiques ou plus",                                  cond:s=>(s.totalEpicSeen??0)>=10,                                                     reward:{rep:200,   money:20000,    talent:0} },
  { id:"rarity_epic_50",       cat:"Rareté", icon:"🟣", name:"Collectionneur Violet",    desc:"Avoir vu 50 voitures Épiques ou plus",                                  cond:s=>(s.totalEpicSeen??0)>=50,                                                     reward:{rep:500,   money:80000,    talent:1} },
  { id:"rarity_first_legendary",cat:"Rareté",icon:"🟡", name:"Première Légende",         desc:"Vendre une voiture Légendaire",                                        cond:s=>(s.totalLegendarySold??0)>=1,                                                 reward:{rep:500,   money:50000,    talent:1} },
  { id:"rarity_legendary_5",   cat:"Rareté", icon:"🟡", name:"Touche d'Or",              desc:"Vendre 5 voitures Légendaires",                                        cond:s=>(s.totalLegendarySold??0)>=5,                                                 reward:{rep:1500,  money:200000,   talent:1} },
  { id:"rarity_legendary_25",  cat:"Rareté", icon:"🟡", name:"Main en Or",               desc:"Vendre 25 voitures Légendaires",                                       cond:s=>(s.totalLegendarySold??0)>=25,                                                reward:{rep:5000,  money:800000,   talent:2} },
  { id:"rarity_first_mythic",  cat:"Rareté", icon:"🔴", name:"Le Mythe",                 desc:"Réparer une voiture Mythique",                                         cond:s=>(s.totalMythicRepaired??0)>=1,                                                reward:{rep:2000,  money:500000,   talent:2} },
  { id:"rarity_mythic_3",      cat:"Rareté", icon:"🔴", name:"Élu des Dieux",            desc:"Réparer 3 voitures Mythiques",                                         cond:s=>(s.totalMythicRepaired??0)>=3,                                                reward:{rep:8000,  money:2000000,  talent:3} },
  { id:"rarity_mythic_10",     cat:"Rareté", icon:"🔴", name:"Béni du RNG",              desc:"Réparer 10 voitures Mythiques",                                        cond:s=>(s.totalMythicRepaired??0)>=10,                                               reward:{rep:20000, money:5000000,  talent:4} },
  { id:"rarity_sell_mythic",   cat:"Rareté", icon:"🔴", name:"Jackpot",                  desc:"Vendre une voiture Mythique",                                          cond:s=>(s.totalMythicSold??0)>=1,                                                    reward:{rep:5000,  money:1000000,  talent:2} },
  { id:"rarity_best_mythic",   cat:"Rareté", icon:"🔴", name:"Le Graal",                 desc:"Posséder une Mythique SSS+ en showroom",                               cond:s=>s.showroom?.some(c=>c.rarity==="mythic"&&c.tier==="SSS+"),                  reward:{rep:15000, money:10000000, talent:5} },

  // ── Encyclopédie ─────────────────────────────────────────────────────────
  { id:"enc_first",            cat:"Encyclopédie", icon:"📖", name:"Curieux",             desc:"Découvrir 10 modèles différents",                                      cond:s=>Object.values(s.carBook??{}).filter(e=>e.seen).length>=10,                    reward:{rep:20,    money:1000,     talent:0} },
  { id:"enc_disc_50",          cat:"Encyclopédie", icon:"📖", name:"Explorateur",          desc:"Découvrir 50 modèles différents",                                      cond:s=>Object.values(s.carBook??{}).filter(e=>e.seen).length>=50,                    reward:{rep:100,   money:10000,    talent:0} },
  { id:"enc_disc_150",         cat:"Encyclopédie", icon:"📖", name:"Grand Explorateur",    desc:"Découvrir 150 modèles différents",                                     cond:s=>Object.values(s.carBook??{}).filter(e=>e.seen).length>=150,                   reward:{rep:500,   money:80000,    talent:1} },
  { id:"enc_disc_324",         cat:"Encyclopédie", icon:"📖", name:"Encyclopédiste",       desc:"Découvrir tous les modèles (324)",                                      cond:s=>Object.values(s.carBook??{}).filter(e=>e.seen).length>=324,                   reward:{rep:5000,  money:1000000,  talent:3} },
  { id:"enc_mastered_10",      cat:"Encyclopédie", icon:"🟡", name:"Apprenti Maître",      desc:"Maîtriser 10 modèles (50 répa + 5 raretés chacun)",                    cond:s=>Object.values(s.carBook??{}).filter(e=>typeof getCarBookMastery!=="undefined"?getCarBookMastery(e)>=3:false).length>=10,  reward:{rep:300,   money:50000,    talent:1} },
  { id:"enc_mastered_50",      cat:"Encyclopédie", icon:"🟡", name:"Expert en Modèles",    desc:"Maîtriser 50 modèles",                                                 cond:s=>Object.values(s.carBook??{}).filter(e=>typeof getCarBookMastery!=="undefined"?getCarBookMastery(e)>=3:false).length>=50,  reward:{rep:2000,  money:400000,   talent:2} },
  { id:"enc_mastered_200",     cat:"Encyclopédie", icon:"🟡", name:"Maître Encyclopédiste",desc:"Maîtriser 200 modèles",                                                cond:s=>Object.values(s.carBook??{}).filter(e=>typeof getCarBookMastery!=="undefined"?getCarBookMastery(e)>=3:false).length>=200, reward:{rep:10000, money:3000000,  talent:4} },
  { id:"enc_familiar_100",     cat:"Encyclopédie", icon:"🟢", name:"Mécanicien Expérimenté",desc:"Avoir 100 modèles familiers ou maîtrisés",                            cond:s=>Object.values(s.carBook??{}).filter(e=>typeof getCarBookMastery!=="undefined"?getCarBookMastery(e)>=2:false).length>=100, reward:{rep:800,   money:150000,   talent:1} },

  // ── Garage Personnel (Collection) ─────────────────────────────────────────
  { id:"coll_first",           cat:"Exposition", icon:"🏠", name:"Premier Coup de Cœur",  desc:"Exposer une première voiture dans le garage personnel",                 cond:s=>(s.collection?.length??0)>=1,                                                 reward:{rep:30,    money:2000,     talent:0} },
  { id:"coll_full_1",          cat:"Exposition", icon:"🏠", name:"Galerie Personnelle",    desc:"Remplir tous les slots d'exposition (au moins 2)",                     cond:s=>(s.collection?.length??0)>1&&s.collection?.length>=(s.collectionCap??1),     reward:{rep:200,   money:30000,    talent:0} },
  { id:"coll_legendary",       cat:"Exposition", icon:"🏠", name:"Joyau de la Collection", desc:"Exposer une voiture Légendaire",                                       cond:s=>s.collection?.some(c=>c.rarity==="legendary"),                               reward:{rep:1000,  money:200000,   talent:1} },
  { id:"coll_mythic",          cat:"Exposition", icon:"🏠", name:"Trésor Absolu",          desc:"Exposer une voiture Mythique",                                         cond:s=>s.collection?.some(c=>c.rarity==="mythic"),                                  reward:{rep:5000,  money:1000000,  talent:2} },
  { id:"coll_sss_plus",        cat:"Exposition", icon:"🏠", name:"SSS+ en Vitrine",        desc:"Exposer une voiture SSS+",                                             cond:s=>s.collection?.some(c=>c.tier==="SSS+"),                                      reward:{rep:3000,  money:500000,   talent:2} },
  { id:"coll_prestige",        cat:"Exposition", icon:"🏠", name:"Patrimoine Automobile",  desc:"Avoir une voiture en exposition après un prestige",                    cond:s=>(s.prestigeCount??0)>=1&&(s.collection?.length??0)>=1,                       reward:{rep:500,   money:100000,   talent:1} },
  { id:"coll_expo_premium_max",cat:"Exposition", icon:"🖼️", name:"Palais de l'Exposition", desc:"Acheter Exposition Premium au niveau maximum (4)",                     cond:s=>s.upgrades?.find(u=>u.id==="expo_premium")?.lvl>=4,                          reward:{rep:2000,  money:500000,   talent:2} },

  // ── Catalogue (nouveaux véhicules) ───────────────────────────────────────
  { id:"catalog_424",          cat:"Encyclopédie", icon:"📖", name:"Nouveau Catalogue",    desc:"Réparer un modèle issu du nouveau catalogue (424 voitures)",            cond:s=>Object.values(s.carBook??{}).filter(e=>e.seen).length>=325,                   reward:{rep:100,   money:10000,    talent:0} },
